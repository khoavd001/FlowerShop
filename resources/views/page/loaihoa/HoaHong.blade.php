    ...
    <div class="container mt-5">
        ...
        <div class="slick-slider-wrapper">
            <div class="container__flower-list-slick-slider bohoa">
                {!! \App\Helper\Loaihoa::slideBH($BoHoa) !!}
            </div>
            <div class="flower-list--slick-slider-paginator-arrow">
                <ul>
                    <li class="prev-LH"><i class="far fa-angle-left"></i></li>
                    <li class="next-LH"><i class="far fa-angle-right"></i></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        ...
        <div class="slick-slider-wrapper">
            <div class="container__flower-list-slick-slider giohoa">
                {!! \App\Helper\Loaihoa::slideGH($GioHoa) !!}
            </div>
            <div class="flower-list--slick-slider-paginator-arrow">
                <ul>
                    <li class="prev-HHGH"><i class="far fa-angle-left"></i></li>
                    <li class="next-HHGH"><i class="far fa-angle-right"></i></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        ...
        <div class="slick-slider-wrapper">
            <div class="container__flower-list-slick-slider hophoa">
                {!! \App\Helper\Loaihoa::slideHH($HopHoa) !!}
            </div>
            <div class="flower-list--slick-slider-paginator-arrow">
                <ul>
    ...
    <div class="container mt-3">
        ...
        <div class="slick-slider-wrapper">
            <div class="container__flower-list-slick-slider chucmung">
                {!! \App\Helper\Loaihoa::slideCM($ChucMung) !!}
            </div>
            <div class="flower-list--slick-slider-paginator-arrow">
                <ul>
...
@section('footer')
    ...
    <script src="{{asset('../public/loaihoa/main.js')}}"></script>
